...
//     // 총 결제금액(비과세 포함 금액)
//     const [basicToal, setBasicTotal] = useState(0);
//     const [stuTotal, setStuTotal] = useState(0);
//     const [douTotal, setDouTotal] = useState(0);
//     const [eveTotal, setEveTotal] = useState(0);
//     // 학생 할인 티켓 금액
...
//       setType('basic');
//       setCount(count +1);
//       totalPayChange(ticket, values, tax, total, price);
//     }
//     const handleChangeStuValue = e => {
//       let values = e.target.value;
//       setStuValue(values);
//       setType('student');
//       setCount(count +1);
//       totalPayChange(ticket, values, tax, total, student);
//     }
//     const handleChangeDouValue = e => {
//       let values = e.target.value;
//       setDouValue(values);
//       setType('double');
//       setCount(count +1);
//       totalPayChange(ticket, values, tax, total, double);
//     }
//     const handleChangeEveValue = e => {
//       let values = e.target.value;
//       setEveValue(values);
//       setType('event');
//       setCount(count +1);
//       totalPayChange(ticket, values, tax, total, openEvent);
//     }
...
//               <select name='basic' value={value} onChange={handleChangeValue}>
//                 <option>{0}</option>
//                 <option>{1}</option>
//                 <option>{2}</option>
//                 <option>{3}</option>
...
//             <td>{student}</td>
//             <td className='select-box'>
//               <select name='student' value={stuValue} onChange={handleChangeStuValue}>
//                 <option>{0}</option>
//                 <option>{1}</option>
//                 <option>{2}</option>
//                 <option>{3}</option>
...
//             <td>{double}</td>
//             <td className='select-box'>
//               <select name='double' value={douValue} onChange={handleChangeDouValue}>
//                 <option>{0}</option>
//                 <option>{1}</option>
//                 <option>{2}</option>
//                 <option>{3}</option>
...
//             <td>{openEvent}</td>
//             <td className='select-box'>
//               <select name='event' value={eveValue} onChange={handleChangeEveValue}>
//                 <option>{0}</option>
//                 <option>{1}</option>
//                 <option>{2}</option>
//                 <option>{3}</option>
...
//       </div>
//       <MyInfo seat={seatList} hour={hour}turn={turn} point={userInfo.userPoint} minute={minute} cancelday={cancelday} title={title} date={date} value={valueSelect()} ticket={ticket} tax={tax} total={total} />
//       </>
//       }
//       {index === 3 && <FinalModal
